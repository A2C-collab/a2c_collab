...
class LLMResponseParser:
    ...
    def __init__(
        ...
        self.use_prepick = use_prepick
        self.use_preplace = use_preplace
    ...
    def parse_open_action(
        ...
        if "right" in open_target:
            inhand = ("cabinet_rightdoor", "right_door_handle", "rightdoorhinge")
        else:
            inhand = ("cabinet_leftdoor", "left_door_handle", "leftdoorhinge") 
    ...
    def parse_pick_and_place(
        ...
        return True, "parse success", [pick_plan[0], place_plan]
    ...
    def parse_move_action(
        ...
        if "," not in target_name:
            ...
            target_quat = robot_state.ee_xquat.copy()
    ...
    def get_place_target_pose(
        ...
        target_quat = robot_state.ee_xquat
        if "," in target_name:
